...
export const projects = [
  ...
  },
  {
    ...
    tags: ["React", "Tailwind CSS", "JavaScript", "Node.js", "Express", "PostgreSQL"],
    status: "live",
  ...
  },
  {
    ...
    tags: ["HTML5", "CSS", "JavaScript", "Node.js"],
    status: "live",
  ...
  },
  {
    ...
    tagline: "Elegant salon storefront (in progress)",
    description:
      "Many beauty salons rely on phone calls and walk-ins, so clients can't browse services or book ahead. This website (work in progress) gives a salon a polished online presence to showcase its services and gallery and let clients book appointments with ease.",
    tags: ["React", "Tailwind CSS", "JavaScript", "Node.js", "Express", "PostgreSQL"],
    status: "wip",
    accent: "from-pink-500/30 to-rose-500/10",
